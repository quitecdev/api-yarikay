                        ...
                        table: {
                            ...
                            body: [
                                ...
                                [
                                    ...
                                    { text: '' },
                                    { text: '' },
                                    { text: `Iva ${iva}`, alignment: 'right', fontSize: 9 },
    ...
    var docDefinition = {
        ...
        content: [{
                columns: [
                    ...
                    [{
                            text: [
                                { text: 'Nº Coprobante: ', style: 'numberDocument', },
                                { text: `${document}`, style: 'numberDocument' },
                    ...
                    table: {
                        ...
                        body: [
                            ...
                            [
                                ...
                                { text: '' },
                                { text: '' },
                                { text: `Iva ${iva}`, alignment: 'right', fontSize: 10 },
...
let pdfInvoiceRegenerate = (req, res) => {
    ...
    SaleModel.aggregate(query).exec((err, saleResponse) => {

        if (saleResponse) {

            let sale = saleResponse[0];
            let document = sale.document;
            let client = sale.client;
            let details = sale.details;
            let due = sale.due;
            let payment = sale.payment;
            let filename = sale.attachment;
